        ...
        <Dialog as='div' className="relative z-10 " onClose={closeModel} >
            ...
            <div className="fixed inset-0 overflow-y-auto">
             ...
             >
                ...
                <Dialog.Panel className="relative w-full mx-w-lg mx-h-[90vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl transition-all flex flex-col gap-5">
                     ...
                     <div className="flex-1 flex flex-col gap-2">
                        ...
                        <div className='flex gap-3'>
                          ...
                          <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                            <Image src={generateCarImageUrl(car, "33")} alt='car model' fill priority className='object-contain mt-3' />
                          </div>
                          <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
